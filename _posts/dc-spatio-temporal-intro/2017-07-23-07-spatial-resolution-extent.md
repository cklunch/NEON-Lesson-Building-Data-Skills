...
Let's explore that next.
    ...
    ## Error in raster(nrow = 4, ncol = 4): could not find function "raster"

    # assign some random data to the raster
    myRaster1[]<- 1:ncell(myRaster1)

    ## Error in ncell(myRaster1): could not find function "ncell"

    # view attributes of the raster
    myRaster1

    ## Error in eval(expr, envir, enclos): object 'myRaster1' not found
    ...
    ## Error in plot(myRaster1, main = "Raster with 16 pixels"): object 'myRaster1' not found
...
Let's open up a raster in `R` to see how the attributes are stored.
    ...
    ## Error in raster("DigitalTerrainModel/SJER2013_DTM.tif"): could not find function "raster"
