...
(Note, as of Sept. 2016, these is a mismatch in the data downloaded and the
...
There are 94 NA values in our dataset.  This is missing data, do we need to 
worry about the missing data?  Could they affect our analyses?  
...
### Units & Scale
If you are using a dataset downloaded before 2016, the units were in **hundredths of an inch**, this isn't the most useful measure. Let's create a new
