...
* R Coding Lesson for Precipitation Data *addition time requirement
* R Coding Lesson for Drought Data 
* R Coding Lesson for Stream Gauge Data 


## Lesson Goals 
After completion of the lesson, students will be able to: 

* Explain that data must be collected repeatedly over time to 
quantify and study change in the environment.
