...
## Why was The Flooding so Destructive? 
 ...
 <figure>
	<a href="{{ site.baseurl }}images/disturb-events-co13/N_St_Vrain_before_and_after_CreditBouldeCo.jpg">
	<img src="{{ site.baseurl }}images/disturb-events-co13/N_St_Vrain_before_and_after_CreditBouldeCo.jpg"></a>
...
<figure>
   <a href="{{ site.baseurl }}/images/maps/inundated.geojson">
   <img src="{{ site.baseurl }}/images/maps/inundated.geojson"></a>
