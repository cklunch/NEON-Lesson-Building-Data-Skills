...
* Download stream gage data from <a href="http://waterdata.usgs.gov/nwis" target="_blank"> USGS's National Water Information System</a>. 
...
<a href="{{ site.baseurl }}/R/USGS-Stream-Discharge-Data-R/#work-with-stream-gage-data" target="_blank"> Work With Stream Gage Data header</a>.

#### Step 1: Search for the data

To search for stream gage data in a particular area, we can use the 
<a href="http://maps.waterdata.usgs.gov/mapper/index.html" target="_blank"> interactive map of all USGS stations</a>.
By searching for locations around "Boulder, CO", we can find 3 gages in the area. 

For this lesson, we want data collected by USGS stream gage 06730200 located on 
Boulder Creek at North 75th St. This gage is one of the few the was able to continuously
...
" target="_blank"> Boulder Creek stream gage 06730200 page</a>, we can now see 
...
library doesn't (yet?) recognize the `limits` method of subsetting. 
