...
ind_noD$date <- as.Date(ind_noD$editedDate)
...
ind_last <- ind_noD %>%
	...
	filter(!duplicated(date==(max(editedDate))))
...
# Create a new dataframe "phe_ind" with all the data
phe_ind <- left_join(status_noD, ind_last, by='individualID')
